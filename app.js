...
function initServer (args) {
    ...
    // passport
    require('./lib/app/passport')(passport);
...
//    });
    ...
    // editview
    app.get(_routes.editview, isLoggedIn, r.editview.get, r.render.admin);
    app.post(_routes.editview, isLoggedIn, r.editview.post, r.render.admin);

    // listview
    app.get(_routes.listview, isLoggedIn, r.listview.get, r.render.admin);
    app.post(_routes.listview, isLoggedIn, r.listview.post, r.render.admin);

    // mainview
    app.get(_routes.mainview, isLoggedIn, r.mainview.get, r.render.admin);

    // not found
    app.all('*', isLoggedIn, r.notfound.get, r.render.admin);
